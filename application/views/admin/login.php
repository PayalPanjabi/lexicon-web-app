...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url(); ?>uploads/school_content/admin_small_logo/fav.png" rel="shortcut icon" type="image/x-icon">
        <!-- CSS -->
                                ...
                                <div class="loginbg loginradius login390">  
                                    <div class="form-top">
                                        <div class="form-top-left logowidth">
                                            <img src="<?php echo base_url(); ?>uploads/school_content/admin_logo/logo1.png" />    
                                        </div>
